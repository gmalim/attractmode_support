...
MAMEDIR="${HOME}/SDLMAME v0.193 64-bit/"    # Directory containing your mame executable 
AMSUPPORTDIR="${HOME}/attractmode_support/" # Your 'attractmode_support' directory 

# 2) Open a terminal and cd to the directory that contains this startup script.
# 3) Type: source mame.bash {game}
#
